...
class QuizResult
{
     ...
     *
     * @var Collection|ArrayCollection Collection|ArrayCollection
     */
    #[ORM\OneToMany(mappedBy: 'quizResult', targetEntity: UserAnswer::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
